...
class MeetupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meetup" do
    assert_difference('Meetup.count') do
      post meetups_url, params: { meetup: { description: @meetup.description, name: @meetup.name, password: @meetup.password } }
    end
  ...
  test "should update meetup" do
    patch meetup_url(@meetup), params: { meetup: { description: @meetup.description, name: @meetup.name, password: @meetup.password } }
